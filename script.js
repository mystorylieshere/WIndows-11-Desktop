...
msedgebox.addEventListener("click",()=>{
    if(msedgebox.style.top=="2vh"){
    msedgebox.style.top="120vh"
    }
    else{
...
vscodebox.addEventListener("click",()=>{
    if(vscodebox.style.top=="2vh"){
        vscodebox.style.top="120vh"
    }
    else{
        vscodebox.style.top="2vh";
...
msstorebox.addEventListener("click",()=>{
    if(msstorebox.style.top=="2vh"){
        msstorebox.style.top="120vh"
    }
    else{
        msstorebox.style.top="2vh";
...
notepadbox.addEventListener("click",()=>{
    if(notepadbox.style.top=="2vh"){
        notepadbox.style.top="120vh"
    }
    else{
        notepadbox.style.top="2vh";
...
paintbox.addEventListener("click",()=>{
    if(paintbox.style.top=="2vh"){
        paintbox.style.top="120vh"
    }
    else{
        paintbox.style.top="2vh";
...
fexpbox.addEventListener("click",()=>{
    if(fexpbox.style.top=="2vh"){
        fexpbox.style.top="120vh"
    }
    else{
        fexpbox.style.top="2vh";
